  ...
  const steps = [
    {
      number: "01",
      title: "Step 1 : Apply",
      description: "Submit your healthcare idea with basic details no complex paperwork.",
      iconType: "document",
    },
    {
      number: "02",
      title: "Step 2 : Review",
      description: "Our team evaluates clinical viability, impact, and market potential.",
      iconType: "validation",
      reverse: true,
    },
    {
      ...
      <div className="professionals-process-steps">
        {steps.map((step, index) => (
          <div key={index} className="professionals-process-step">
            {/* Desktop: SVG Dashed Circle */}
            <svg
              className="hidden md:block absolute left-0 w-80 h-80"
              viewBox="0 0 320 320"
              fill="none"
              style={{
                top: step.reverse ? "52px" : "56px",
              }}
            >
              {index % 2 === 0 ? (
                <path
            ...
            {/* Text Content */}
            <div className="professionals-process-step-content">
