      ...
      <div className="sol9x-hero-container">
        ...
        <div className="sol9x-hero-badge">
          ...
          <span className="sol9x-hero-badge-text">
            Innovative AI and Robotics Solutions for Creative Industries
          </span>
        </div>
        ...
        <div className="sol9x-hero-content">
          ...
          <div className="sol9x-hero-headlines">
            ...
            <p className="sol9x-hero-description">
              Transforming content creation, production, and distribution with AI-powered tools and immersive robotics for next-generation entertainment.
            </p>
          </div>
