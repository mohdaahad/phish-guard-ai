      ...
      <div className="defence-cta-container">
        ...
        <div className="defence-cta-content">
          <h2 className="defence-cta-title">
            Ready to Transform <span className="defence-cta-title-highlight">Education</span>?
          </h2>
          <p className="defence-cta-description">
            Join leading educational institutions leveraging AI and VR to create exceptional learning experiences
          </p>
        </div>
