...
export default function DefenceCTASection() {
      ...
      <div className="defence-cta-container">
        ...
        <div className="defence-cta-content">
          <h2 className="defence-cta-title">
            Ready to Strengthen Your <span className="defence-cta-title-highlight">Defence Capabilities?</span>
          </h2>
          <p className="defence-cta-description">
            Let's build secure, intelligent systems that perform under pressure and scale with mission demands.
          </p>
        </div>
