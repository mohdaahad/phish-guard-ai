      ...
      <div className="sol9x-hero-container">
        ...
        <div className="sol9x-hero-badge">
          ...
          <span className="sol9x-hero-badge-text">
            Enterprise-Grade Cybersecurity with AI-Powered Threat Detection
          </span>
        </div>
        ...
        <div className="sol9x-hero-content">
          ...
          <div className="sol9x-hero-headlines">
            ...
            <p className="sol9x-hero-description">
              Protecting digital assets with intelligent threat detection, behavioral analytics, and comprehensive security operations powered by AI.
            </p>
          </div>
