    ...
    <section className="professionals-hero">
      <div className="professionals-hero-bg">
        <Image
          ...
          alt="Professionals collaboration"
          fill
      ...
      <div className="professionals-hero-content">
        <div className="professionals-hero-text-group">
          <div className="professionals-hero-headline-wrapper">
            ...
            <p className="professionals-hero-subtext poppins-font">
              We support bold founders with funding up to <span className="professionals-hero-highlight-text">₹50Lacs</span>, hands-on
          ...
          <button className="professionals-hero-button poppins-font">
            <span className="professionals-hero-button-text">Apply for funding</span>
          </button>
        </div>

        <p className="professionals-hero-footnote poppins-font">
